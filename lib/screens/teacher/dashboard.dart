...
class TeacherDashboardGrid extends StatefulWidget {
  const TeacherDashboardGrid({super.key});

  @override
  State<TeacherDashboardGrid> createState() => _TeacherDashboardGridState();
}
                ...
                InkWell(
                  onTap: () {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) => const TeacherManageDashboard()));
                  },
                  child: Card.filled(
                    color: Theme.of(context).colorScheme.primaryContainer,
                    shape: RoundedRectangleBorder(
                    ...
                    child: Column(
                      ...
                      children: [
                        Expanded(
                            child: Lottie.asset("assets/lottie/man_quran1.json",
                                frameRate: const FrameRate(15))),
                        Text(
