...
class AdminDashboardGrid extends StatefulWidget {
  const AdminDashboardGrid({super.key});

  @override
  State<AdminDashboardGrid> createState() => _AdminDashboardGridState();
}

class _AdminDashboardGridState extends State<AdminDashboardGrid> {
              ...
              child: GridView.custom(
                ...
                childrenDelegate: SliverChildListDelegate([
                  ...
                  InkWell(
                    onTap: () {
                      Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) => const ParentManageDashboard()));
                    },
                    child: Card.filled(
                      color: Theme.of(context).colorScheme.primaryContainer,
                      shape: RoundedRectangleBorder(
                      ...
                      child: Column(
                        ...
                        children: [
                          Expanded(
                              child: Lottie.asset(
                                  "assets/lottie/teacher_kid.json",
                                  frameRate: const FrameRate(15))),
                          Text(
                            context.loc.parents,
                            style: Theme.of(context).textTheme.bodyLarge,
